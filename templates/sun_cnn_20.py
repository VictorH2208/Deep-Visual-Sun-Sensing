...
if __name__ == "__main__": 
    ...
    optimizer = torch.optim.Adam(params, lr=0.0005, weight_decay= 0.0000001, amsgrad=True) # set learning rate to 0.0005 and a weight decay and turn on amsgrad to incerase convergence
